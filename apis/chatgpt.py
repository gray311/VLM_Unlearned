...
class GPTEvaluator:
    def __init__(self, api_key, model='gpt-4o-2024-05-13', api_url="https://api.openai.com/v1/chat/completions", max_tokens=2048, temperature=0.1, top_p=1, presence_penalty=0.0, frequency_penalty=0.0):
